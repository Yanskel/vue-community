<template>
  <div>
    ...
    <el-dialog title="物资申请" :visible.sync="dialogVisible" width="30%" :before-close="handleClose">
      <el-form ref="form" :model="form" label-width="80px">
        <el-form-item label="物资名称">
          <el-select v-model="form.suppliesId" placeholder="请选择物资">
            <el-option v-for="s in supplies" 
              :key="s.id" 
              :label="s.name" 
              :value="s.id">
          </el-option>
        ...
        <span class="tips">*单位：N95口罩——盒(10个)；消毒液，酒精——瓶；
          <br>&emsp;&emsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;PVC手套——盒(10个)；电子体温计——个；
          <br>&emsp;&emsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;矿泉水——箱(24瓶)；方便面——箱(24袋)；
          <br>&emsp;&emsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;卫生纸——提(10卷)；布洛芬缓释胶囊——盒(24粒)
        </span>
      </el-form>
